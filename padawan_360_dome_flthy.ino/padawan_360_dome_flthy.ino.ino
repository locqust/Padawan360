...
void loop() 
{
  ...
  case 4:
    while((textScrollCount[0]<1) || (textScrollCount[1]<1) || (textScrollCount[2]<1)) // keep scrolling until they have all scrolled once
    {
      if (textScrollCount[0]<1) scrollText(0,"WARNING");  //top front text
      if (textScrollCount[1]<1) scrollText(1,"  IMPERIALS DETECTED");  //bottom front text
  ...
  case 22:
    while((textScrollCount[0]<1) || (textScrollCount[1]<1) || (textScrollCount[2]<1)) // keep scrolling until they have all scrolled once
    {
      if (textScrollCount[0]<1) scrollText(0," I AM LATE");  //top front text
      scrollText(1,"  GOT TO HURRY ");  //bottom front text
      if (textScrollCount[2]<1) scrollText(2,"I AM LATE GOT TO HURRY");   //rear text
    }
