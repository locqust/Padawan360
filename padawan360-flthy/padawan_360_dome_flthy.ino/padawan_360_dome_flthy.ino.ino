...
char RLDtext[] = "R2-D2 ASTROMECH"; //PUT YOUR REAR STARTUP TEXT HERE.
...
void loop() 
{
  ...
  case 4:
    while((textScrollCount[0]<1) || (textScrollCount[1]<1) || (textScrollCount[2]<1)) // keep scrolling until they have all scrolled once
    {
      if (textScrollCount[0]<1) scrollText(0,"Warning! Imperials Detected!");  //top front text
      if (textScrollCount[1]<1) scrollText(1," Warning! Imperials Detected!");  //bottom front text
      if (textScrollCount[2]<1) scrollText(2,"Warning! Imperials Detected!");   //rear text
    }
  ...
  case 21:
    while((textScrollCount[0]<1) || (textScrollCount[1]<1) || (textScrollCount[2]<1)) // keep scrolling until they have all scrolled once
    {
      if (textScrollCount[0]<1) scrollText(0," Taking my time");  //top front text
      scrollText(1,"  In no hurry  ");  //bottom front text
      if (textScrollCount[2]<1) scrollText(2,"Taking my time. In no hurry");   //rear text
    }
  ...
  case 22:
    while((textScrollCount[0]<1) || (textScrollCount[1]<1) || (textScrollCount[2]<1)) // keep scrolling until they have all scrolled once
    {
      if (textScrollCount[0]<1) scrollText(0," I'm late!");  //top front text
      scrollText(1,"  Got to hurry! ");  //bottom front text
      if (textScrollCount[2]<1) scrollText(2,"I'm late! Got to hurry!");   //rear text
    }
  ...
  case 23:
    while((textScrollCount[0]<1) || (textScrollCount[1]<1) || (textScrollCount[2]<1)) // keep scrolling until they have all scrolled once
    {
      if (textScrollCount[0]<1) scrollText(0," Get out of the way! ");  //top front text
      scrollText(1,"  Coming through!  ");  //bottom front text
      if (textScrollCount[2]<1) scrollText(2,"Get out of the way! Coming through!");   //rear text
    }
